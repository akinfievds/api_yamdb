# Generated by Django 3.0.5 on 2021-06-26 20:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.CharField(blank=True, max_length=300, verbose_name='Информация о пользователе')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(blank=True, validators=[api.validators.year_validator], verbose_name='Год выпуска произведения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(validators=[django.core.validators.MinValueValidator(1, message='Оценка отзыва может быть в диапазоне от 1 до 10'), django.core.validators.MaxValueValidator(10, message='Оценка отзыва может быть в диапазоне от 1 до 10')], verbose_name='Оценка отзыва')),
